...
func (m *Matrix3x3) Create(a11, b11, c11, a21, b21, c21, a22, b22, c22 float64) *Matrix3x3 {
	(*m)[0], (*m)[1], (*m)[2], (*m)[3], (*m)[4], (*m)[5], (*m)[6], (*m)[7], (*m)[8] = a11, b11, c11, a21, b21, c21, a22, b22, c22
	return m
}

func (m *Matrix2x2) Create(a11, b11, a21, b21 float64) *Matrix2x2 {
...
func (m *Matrix3x3) Minorij(i, j int) *Matrix2x2 {
	...
	switch {
	case i == 0 && j == 0:
		return t.Create((*m)[4], (*m)[5], (*m)[7], (*m)[8])
	case i == 0 && j == 1:
		return t.Create((*m)[3], (*m)[5], (*m)[6], (*m)[8])
	case i == 0 && j == 2:
		return t.Create((*m)[3], (*m)[4], (*m)[6], (*m)[7])
	case i == 1 && j == 0:
		return t.Create((*m)[1], (*m)[2], (*m)[7], (*m)[8])
	case i == 1 && j == 1:
		return t.Create((*m)[0], (*m)[2], (*m)[6], (*m)[8])
	case i == 1 && j == 2:
		return t.Create((*m)[0], (*m)[1], (*m)[6], (*m)[7])
	case i == 2 && j == 0:
		return t.Create((*m)[1], (*m)[2], (*m)[4], (*m)[5])
	case i == 2 && j == 1:
		return t.Create((*m)[0], (*m)[2], (*m)[3], (*m)[5])
	case i == 2 && j == 2:
		return t.Create((*m)[0], (*m)[1], (*m)[3], (*m)[4])
	default:
		fmt.Println("Wrong params for Minorij method, i,j =", i, j)
		panic(nil)
		return nil
	}
}
...
func (m *Matrix3x3) Del(c float64) *Matrix3x3 {
...
func (m *Matrix3x3) Inverse() *Matrix3x3 {
	det := m.Det()
	if det == 0 {
		fmt.Println("Could't find inverse matrix, det = 0")
		panic(nil)
	}
	return m.Minor().Dop().Trans().Del(det)
